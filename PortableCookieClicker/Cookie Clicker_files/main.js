...
Game.Launch=function()
{
	...
	'<div class="title">Portable version history</div>'+
	...
	'</div><div class="subsection update small">'+
	'<div class="title">7/15/2021 - Topbar</div>'+
	'<div class="listing">&bull; +Added more things to the topbar.</div>'+
	
	'</div><div class="subsection update">'+
	'<div class="title">07/14/2021 - Launch</div>'+
	'<div class="listing">&bull; +Made Cookie Clicker Portable!</div>'+
