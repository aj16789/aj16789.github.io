...
Game.Launch=function()
{
	...
	Game.Load=function()
	{
		...
		Game.Loader.domain='img/oldbeta/';
	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.goldenCookie.spawn=function()
		{
			...
			{
				this.wrath=1;
				if (Game.season=='halloween') me.style.background='url(img/oldbeta/spookyCookie.png)';
				else me.style.background='url(img/oldbeta/wrathCookie.png)';
			}
			else
			{
				this.wrath=0;
				me.style.background='url(img/oldbeta/goldCookie.png)';
			}
			//fancy visual stuff
			...
			{
				me.style.background='url(img/oldbeta/hearts.png)';
			...
			{
				me.style.background='url(img/oldbeta/contract.png)';
				r=Math.floor(Math.random()*8-4);
				if (this.wrath) me.style.background='url(img/oldbeta/wrathContract.png)';
			}
			else if (Game.season=='easter')
			{
				me.style.background='url(img/oldbeta/bunnies.png)';
		...
		Game.seasonPopup.spawn=function()
		{
			...
			{
				me.style.backgroundImage='url(img/oldbeta/frostedReindeer.png)';
			}
		...
		Game.veilOn=function()
		{
			...
			//l('backgroundLayer2').style.background='#000 url(img/oldbeta/darkNoise.jpg)';
			Game.veil=1;
		}
			...
			else if (Game.onMenu=='stats')
			{
				...
				if (Game.Has('A festive hat'))
				{
					for (var i=0;i<=Game.santaLevel;i++)
					{
						...
						,'bottom-right')+' style="width:96px;height:96px;margin:2px;float:left;background:url(img/oldbeta/santa.png) '+(-i*96)+'px 0px;"></div>';
					}
		...
		Game.Object=function(name,commonName,desc,icon,iconColumn,art,price,cps,buyFunction)
		{
			...
			this.rebuild=function()
			{
				...
				l('productIcon'+me.id).style.backgroundImage='url(img/oldbeta/'+icon+')';
				l('productIconOff'+me.id).style.backgroundImage='url(img/oldbeta/'+iconOff+')';
